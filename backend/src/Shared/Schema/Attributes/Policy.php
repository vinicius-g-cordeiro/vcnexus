...
final class Policy {
     ...
     * @param array<string>|string $for for select
     ...
     */
    function __construct(public readonly string $name = 'tenant_membership', public readonly ?string $table = 'tenant_users', public readonly ?bool $restrictive = false, public readonly mixed $for = 'SELECT', public readonly ?string $toUser = 'app_user', public readonly ?array $using = null, public readonly ?array $withCheck = null) {
    }
}