<?php
/**
 * GENERATED from App\Schemas\Authorization\TenantMembershipSchema — do not edit directly. Edit the schema and recompile.
 * @brief 
...
final class TenantMembership extends BaseModel
{
    public ?int $id;
    public ?string $uuid;
    public ?int $active;
    ...
    public static function fromArray(array $data): self
    {
        ...
        $newObject->joined_at = isset($data['joined_at']) ? $data['joined_at'] : null;
