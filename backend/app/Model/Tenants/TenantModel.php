...
final class TenantModel extends Model
{
    ...
    function list(?object $parameters) : object|bool|null|array {
        ...
        $sql = 'select t.id, t.uuid, t.modules,b.legal_name, b.trade_name, b.email, b.phone, b.website, t.slug, b.website, t.subscription_plan, t.name, t.active, t.status,t.created_at_local, t.updated_at_local, t.subscription_plan
