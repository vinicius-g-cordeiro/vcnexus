<template>
    <button type="button" :class="[
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 transition-all duration-300 ease-out" :class="isDark ? 'scale-100 rotate-0 opacity-100' : 'scale-0 rotate-90 opacity-0 absolute'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            stroke-linejoin="round">
