<template>
    <div class="flex bg-neutral-100 dark:bg-zinc-800 min-h-screen text-zinc-900 dark:text-zinc-50">
        <!-- Left: showcase panel -->
        <div class="hidden relative lg:flex bg-zinc-900 lg:w-1/2 overflow-hidden text-zinc-50">
            ...
            <div class="z-10 relative flex flex-col justify-center p-16">
                ...
                <ul class="flex flex-col gap-4 mt-8">
                    <li v-for="point in highlights" :key="point" class="flex items-start gap-3 text-zinc-300 text-sm">
        ...
        <div class="flex flex-col justify-center px-6 sm:px-12 lg:px-20 py-12 w-full lg:w-1/2">
            <div class="mx-auto w-full max-w-md">
                ...
                <div class="flex items-center gap-4 mt-8">
                    <span class="flex-1 bg-zinc-300 dark:bg-zinc-700 h-px" />
                    <span class="text-zinc-500 dark:text-zinc-400 text-xs">or continue with</span>
                    <span class="flex-1 bg-zinc-300 dark:bg-zinc-700 h-px" />
                </div>

                <div class="gap-3 grid grid-cols-2 mt-6">
                    <button type="button" class="inline-flex justify-center items-center gap-2 hover:bg-zinc-300 dark:hover:bg-zinc-700 py-2.5 border border-neutral-300 dark:border-neutral-700 rounded-md font-medium text-sm transition-colors" @click="$emit('oauth', 'google')">
                    ...
                    <button type="button" class="inline-flex justify-center items-center gap-2 hover:bg-zinc-300 dark:hover:bg-zinc-700 py-2.5 border border-neutral-300 dark:border-neutral-700 rounded-md font-medium text-sm transition-colors" @click="$emit('oauth', 'github')">
                        <svg class="w-4 h-4" viewBox="0 0 24 24">
                            <path fill="currentColor"
